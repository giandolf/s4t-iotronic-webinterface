...
class Yun extends CI_Controller {
	...
	public function run_plugin(){
		...
		//$result = $this -> curl -> simple_get('http://<SERVER_IP>:<PORT>/command/?command=plugin&pluginname='.$plugin_name.'&pluginjson='.$plugin_json.'&pluginoperation=run&plugincategory='.$plugin_category.'&board='.$board_id);
	...
	public function call_plugin(){
		...
		//$result = $this -> curl -> simple_get('http://<SERVER_IP>:<PORT>/command/?command=plugin&pluginname='.$plugin_name.'&pluginjson='.$plugin_json.'&pluginoperation=call&plugincategory='.$plugin_category.'&board='.$board_id);
